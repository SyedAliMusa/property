                    ...
                    <div class="card card-outline card-info">
                        ...
                        <form action="{{ route('adminAddBlog') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body pad">
                                ...
                                <div class="form-group">
                                    <label for="">Tags (Separated by comma without space)</label>
                                    <input type="text" name="tags" class="form-control" id="" placeholder="Enter Tags" required>
                                </div>

                                <div class="form-group">
                                    <label>Summary</label>
                                    <textarea  required name="summary" class="form-control" rows="3" placeholder="Enter Summary"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputFile">Featured Image (787 x 344)</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="" name="fImage" required>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Recent Blog Image (246 x 155)</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="" name="rImage" required>
                                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                        </div>
                                    </div>
                                </div>
