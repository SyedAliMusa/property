                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                @foreach($properties as $property)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('adminPropertyDetail', $property->id) }}"><i class="fas fa-eye"></i></a>
            ...
            <div class="modal-content bg-success">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <form action="{{ route('SetType') }}" method="post">
                        @csrf
                        <input type="hidden" value="" name="changeId" id="setChangeId">
                        <input type="hidden" value="" name="type" id="setType">
                        <input type="hidden" value="" name="changeFor" id="changeFor">
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <form action="{{ route('SetType') }}" method="post">
                        @csrf
                        <input type="hidden" value="" name="changeId" id="setChangeIdDan">
                        <input type="hidden" value="" name="type" id="setTypeDan">
                        <input type="hidden" value="" name="changeFor" id="changeForDan">
                        <button type="submit" class="btn btn-outline-light">Save changes</button>
                    </form>
                </div>
            </div>
