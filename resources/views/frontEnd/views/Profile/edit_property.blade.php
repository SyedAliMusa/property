        ...
        <div class="submit-property">
            <div class="container">
                <div role="tabpanel">
                    ...
                    <!-- Tab panes -->
                    <form action="{{ route('editProperty', $property->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="property_information">
                                <div class="contact-feedback-form">
                                    <div class="col-md-12">
                                        <input type="text" required id="property-title" value="{{ $property->title }}" name="title" placeholder="Property Title">
                                    </div>
                                    <div class="col-md-12">
                                        <textarea  rows="4" required name="description" placeholder="Property Description">{{ $property->description }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" value="{{ $property->bedrooms }}" required name="bedrooms" placeholder="Bedrooms">
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" required value="{{ $property->bathrooms }}" name="bathrooms" placeholder="Bathrooms">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" required value="{{ $property->price }}" name="price" placeholder="Price Postfix Text">
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" required name="area" value="{{ $property->area }}" placeholder="Area">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" required value="{{ $property->property_id }}" readonly name="propertyId" placeholder="Property Id">
                                    </div>
                                    <div class="col-md-12">
                                        <input type="text" name="videoUrl" value="{{ $property->video_url }}" placeholder="VirtualTour Video URL">
                                    </div>
                                </div>
                            </div>
                            <!-- submit-property-1/- -->
                                ...
                                <div class="contact-feedback-form">
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input name="features[]" value="Pound" type="checkbox" id="checkbox-1">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input name="features[]" value="Attic" type="checkbox" id="checkbox-5">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input name="features[]" value="Pool" type="checkbox" id="checkbox-9">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input name="features[]" value="Fenced Yard" type="checkbox" id="checkbox-13">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input name="features[]" value="Balcony" type="checkbox" id="checkbox-17">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input  name="features[]" value="Wine Cellar" type="checkbox" id="checkbox-21">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="amenities-checkbox">
                                            <input  name="features[]" value="Fire Place" type="checkbox" id="checkbox-25">
                            ...
                            <div role="tabpanel" class="tab-pane" id="add_location">
                                <div class="contact-feedback-form">
                                    <div class="col-md-10 col-sm-9 col-xs-12 p_z">
                                        <input type="text" value="{{ $property->address }}" name="address" id="address" placeholder="Address">
                                    </div>
